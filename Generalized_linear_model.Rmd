...
# 1. convert True and False in the Linux variable to 0 and 1
games.clean$Linux <- ifelse(games.clean$Linux == "True", 1, 0)

# 2. convert release date to numeric value for the model
games.clean$Release.date <- as.Date(games.clean$Release.date, format = "%b %d, %Y")
