...
The Poisson model is a type of GLM that is used to analyze count data. It can be particularly useful when we expect our response variable not follow a normal distribution or if we suspect non-linear relationships with the predictor variables
...
dlc.model1 <- glm(DLC.count ~ Price + Metacritic.score + Positive + Negative, family = "poisson", data = games.clean)
summary(dlc.model1)
