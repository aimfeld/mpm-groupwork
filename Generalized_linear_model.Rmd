...
For this model we choose the "quasipoisson" argument, because we assume overdispersion in the data and this is confirmed, as we can see the dispersion parameter is larger than 1, at around 12.75 (The regualar Poisson model assumes dispersion parameter of 1). Larger dispersion values hint at the poisson model not being well suited for this analysis. We would definitely have to delve deeper into this and take a look at the DLC metric with other models to verify our observations here.
